...
class cISC3OccupantManagerAnim;
...
public:
    ...
    virtual cISC3OccupantManagerAnim* AnimOccupantManager(void) = 0;
    ...
    virtual cISC3CrimeLayer* CrimeLayer(void) = 0;
    virtual cISC3PoliceLayer* PoliceLayer(void) = 0;
    virtual cISC3FireLayer* FireLayer(void) = 0;
