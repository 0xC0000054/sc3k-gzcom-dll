...
class cIGZUnknownList : public cIGZUnknown
{
	public:
		...
		virtual bool EnumElements(cIGZUnknownEnumerator& sEnum, cIGZUnknown* pUnknown, uint32_t riid) = 0;
		...
		virtual bool ConstEnumElements(cIGZUnknownEnumerator& sEnum, cIGZUnknown* pUnknown, uint32_t riid) const = 0;
};